...
const ProductsManager = () => {
    ...
    const handleUploadInput = e => {
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Files does not exist.'}})
          //The below code is responsible for uploading images , Here it is considered maximum five images
        files.forEach(file => {
        ...
        //Make sure maximum five images are selected
    ...
    const handleSubmit = async(e) => {
        e.preventDefault()
        //If user is not Admin then throes error
        if(auth.user.role !== 'admin') 
        return dispatch({type: 'NOTIFY', payload: {error: 'Authentication is not valid.'}})
       //Make sure every item has been selected
       ...
       // give a nice message that product created
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <div className="col-sm-6">
                            ...
                            placeholder="Product ID" className="d-block w-100 p-2"
                            onChange={handleChangeInput} />
                        </div>
                        <div className="col-sm-6">
